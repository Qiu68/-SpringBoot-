...
//        Account userInfo = getUserInfo(goodsInfo.getUserId(), goodsInfo.getLevel());   没用的代码
//        if (userInfo != null) {
...
//        }
     ...
     * @return
     */
    public List<OrderInfo> getOrderGoods(Long userId, Integer level) {
        ...
        List<OrderInfo> list = orderInfoDao.findByUserId(userId,level);
        return list;
    }
